  ...
  return (
    <div className="p-8 space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-[#181d28] border border-white/5 rounded-lg p-5 flex flex-col h-[500px]">
        ...
        <div className="bg-[#181d28] border border-white/5 rounded-lg p-5 flex flex-col h-[500px]">
          <div className="flex items-center gap-2 mb-4">
            <ShieldCheck className="text-[#00e5c0]" size={18} />
          ...
          <div className="space-y-4 overflow-y-auto pr-2 custom-scrollbar flex-1">
            {[
              ...
              <div key={i} className="p-4 bg-black/40 border border-[#00e5c0]/20 rounded-lg flex flex-col gap-3">
                <div className="flex items-start gap-3">
                  <Fingerprint className="text-[#00e5c0] mt-0.5" size={16} />
                  <div>
                ...
                <div className="flex items-center justify-between mt-2 pt-3 border-t border-[#00e5c0]/20">
                  <div className="text-xs text-red-400 font-mono">{qf.detected}</div>
                  <button className="flex items-center gap-1 px-3 py-1 bg-[#00e5c0]/10 hover:bg-[#00e5c0]/20 text-[#00e5c0] text-xs font-medium rounded transition-colors border border-[#00e5c0]/30">
